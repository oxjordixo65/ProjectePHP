...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Llista Users</a>
                </li>
    ...
    $var = $usuari->registrar();

    if ($var == 0) {
        
        header("Location: productes.php");
    } else if ($var == 1) {
        echo "<br><h2 class='text-center'>\"Usuari ja existent!\"</h2><br><br><br>";
        echo "<a href='./form_signup.php'><button class='btn btn-primary center'>Back</button></a>";
    }
    ?>
